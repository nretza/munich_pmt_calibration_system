...
directory = 'data/' + PMT + '/' + timestr + '-withoutMolton-baseline'
os.mkdir(directory)
suf = '.hdf5'

threshold = [0, -1, -2]  # 0, -1, -2 mV
for t in threshold:
    print('Trigger threshold is', t, 'mV')
    filename = PMT + '-baseline' + str(t) + 'mV' + suf
