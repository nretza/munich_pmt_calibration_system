...
class Occupancy:
    ...
    def occ(self, filename='data/20211022-140412-1.1/20211022-140412-6-4-10.npy', threshold=-4):
        ...
        occ = np.sum(np.where(minval<threshold, 1, 0))/total_number_waveforms
        return occ

    def occ_data(self, data, threshold=-4):
